...
data class PublicRepoModel(
    ...
    companion object CREATOR : Parcelable.Creator<PublicRepoModel> {
        override fun createFromParcel(parcel: Parcel): PublicRepoModel {
            return PublicRepoModel(parcel)
        }

        override fun newArray(size: Int): Array<PublicRepoModel?> {
